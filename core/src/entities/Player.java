...
public class Player extends Sprite {
    ...
    public void update(float delta) {
        ...
        if (velocity.x < 0) {
            ...
            //middle right
            if (!collisionX)
                collisionX = collisionLayer.getCell((int) ((getX() + getWidth()) / tileWidth), (int) ((getY() + getHeight() / 2) / tileWidth)).getTile().getProperties().containsKey("blocked");
            //bottom right
            if (!collisionX)
        ...
        if (velocity.y < 0) {
            ...
            //bottom middle
            if (!collisionY)
                collisionY = collisionLayer.getCell((int) ((getX() + getHeight() / 2) / tileWidth), (int) (getY() / tileHeight)).getTile().getProperties().containsKey("blocked");
            //bottom right
            if (!collisionY)
                collisionY = collisionLayer.getCell((int) ((getX() + getHeight()) / tileWidth), (int) (getY() / tileHeight)).getTile().getProperties().containsKey("blocked");
